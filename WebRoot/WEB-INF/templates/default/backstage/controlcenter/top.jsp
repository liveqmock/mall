...
.My {  font-size: 25px; color:#FFFFFF; font-weight: :bold ；padding-left:10px;
padding-top:5px;}
TD.top {
...
<BODY bgColor=#ffffff ><TABLE class="control_top_table" cellSpacing=0 cellPadding=0 width="100%" 
bgColor=#6386de border=0 valign="top">
  <TBODY>
  <TR vAlign=top>
      <TD vAlign=top width="450" class="My" Align=left><!-- <a href="/" target="_blank"><img src="/images/global/logo.gif" alt="回到AngelInTheBox前台" title="回到AngelInTheBox前台" border="0"/></a> --></TD>
    <TD width="124">
      ...
      bgColor=#6386de border=0>
        ...
        <TR vAlign=bottom height=20>
          <TD width=18><IMG src="images/top_toolbar.gif" border=0></TD>
            ...
            <TD class=top bgColor=#000000><NOBR>登录者：${administrator.name }| 当前日期-<%=formatter.format(dNow) %></NOBR></TD>
            </TR>
        <TR height=38>
          <TD></TD>
          <TD vAlign=center align=right><A 
            ...
            title="" onmouseout="MM_nbGroup('out');" 
             target="mainframe">
            ...
            onmouseout="MM_nbGroup('out');"  target="mainframe"><img id=OAHeader_r1_c3 
            ...
            src="OAHeader_r1_c5.gif" border=0 
