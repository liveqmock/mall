...
<input type="hidden" name="method" value="updateArticleType"/>
<input type="hidden" name="id" value="${type.id }"/>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="text" name="name" size="50" maxlength="50" value="${type.name}"/>
        <font color="#FF0000">*</font></td>
    </tr>
     <tr bgcolor="f5f5f5"><td><div align="right">列表显示模板路径</div></td><td> 
    <input type="text" name="templateUrl" value="${type.templateUrl}"/></td>
    </tr>
             <tr><td><div align="right">前台列表页面标题</div></td><td>
    <input type="text" name="title" value="${type.title}"/></td>
    </tr>
          <tr><td><div align="right">前台列表页面关键词</div></td><td>
    <input type="text" name="keywords" value="${type.keywords}"/></td>
    </tr>
          <tr><td><div align="right">前台列表页面描述</div></td><td>
    <input type="text" name="description" value="${type.description}"/></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
