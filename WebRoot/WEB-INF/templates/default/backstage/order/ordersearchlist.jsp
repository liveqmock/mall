...
<TITLE>订单查询结果</TITLE><link type="text/css" rel="stylesheet" href="css/product/list.css">
<SCRIPT LANGUAGE="JavaScript" src="js/Country.js" type="text/javascript"></SCRIPT>
  ...
  String orderId = request.getAttribute("orderId")==null?"":(String)request.getAttribute("orderId");
     String orderState = request.getAttribute("orderState")==null?"":(String)request.getAttribute("orderState");
...
String pageSplits = ConstantString.generatePageSplit(
		...
		"control/shopping/ordermanage.do?method=search&orderId="+
				orderId+"&orderState="+orderState+"&userName="+userName+"&userEmail="+userEmail+"&date="+date+"&");
out.println(pageSplits);
%>  </div>
   </td></tr>
    <tr>
      <td width="3%" bgcolor="6f8ac4"> <div align="center">选择</div></td>
      <td width="10%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">订单号</font></div></td>
      <td width="6%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">商品总金额</font></div></td>
      <td width="6%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">订单总金额</font></div></td>
      <td width="6%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">配送费用</font></div></td>
      <td width="6%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">应付费用</font></div></td>
      <td width="16%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">下单时间</font></div></td>
      <td width="5%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">支付状态</font></div></td>
      <td width="5%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">支付方式</font></div></td>
      <td width="10%" bgcolor="6f8ac4"> <div align="center"><font color="#FFFFFF">用户</font></div></td>
