...
<input type="hidden" name="menuGroupId" value="${menuForm.menuGroupId }"/>
...
<br>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      <td> <div align="left">菜单项名称 ：<font color="#FF0000">*</font><input type="text" name="name"></div></td>
      
       
    </tr>
     <tr bgcolor="f5f5f5"> 
      <td> <div align="left">菜单项链接地址 ：<font color="#FF0000">*</font><input type="text" name="link"></div></td>
      
       
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td> <div align="left">排序号</div></td>
    </tr>
    
    <tr bgcolor="f5f5f5"> 
      <td> <div align="left"><input type="text" name="orderNo"/></div></td>
     </tr>
    <tr bgcolor="f5f5f5"> 
      <td> <div align="center"> 
