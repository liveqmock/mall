...
<input type="hidden" name="menuGroupId" value="${group.id }"/>
...
<br>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      <td> <div align="left">菜单组名称 ：<font color="#FF0000">*</font><input type="text" name="name" value="${group.name }"></div></td>
      
       
    </tr>
	<tr bgcolor="f5f5f5"> 
      <td> <div align="left">排序号:<input type="text" name="orderNo" value="${group.orderNo }"/></div></td>
     </tr>
    <tr bgcolor="f5f5f5"> 
      <td> <div align="center"> 
