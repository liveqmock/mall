...
<input type="hidden" name="method" value="updateProductDetailAttribute"/>
<input type="hidden" name="productId" value="${productForm.productId }"/><input type="hidden" name="id" value="${attribute.id }"/>
<br>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    <tr bgcolor="6f8ac4"><td colspan="2"  > <font color="#FFFFFF"></font></td>
    </tr>
    <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">产品详情属性名称</div></td>
      <td width="78%"> <input type="text" name="name" size="50" maxlength="50" value="${attribute.name}"/>
    </tr>
    <tr bgcolor="f5f5f5"> 
