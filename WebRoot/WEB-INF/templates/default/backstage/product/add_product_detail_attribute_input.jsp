...
<input type="hidden" name="method" value="addProductDetailAttribute"/>
<input type="hidden" name="productId" value="${productForm.productId }"/><input type="hidden" name="id" value="${group.id }"/>
<br>
