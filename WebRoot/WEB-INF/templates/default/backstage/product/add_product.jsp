  ...
  <table width="98%" border="0" cellspacing="1" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="90%"><input type="hidden" name="categoryId"/> <input type="text" name="categoryName" disabled="true" size="30"/> <font color="#FF0000">*</font> 
        <input type="button" name="select" value="选择..." onClick="javaScript:window.open('<html:rewrite action="control/product/product/manage"/>?method=selectCategory','列表',600,400)">(<a href="<html:rewrite action='/control/product/category/manage'/>?method=addInput">添加产品类别</a>)      </td>
    </tr>
	<tr bgcolor="f5f5f5"> 
