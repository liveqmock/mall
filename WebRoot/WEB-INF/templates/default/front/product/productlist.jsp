...
></c:out><%=WebProperty.readUrl("site.front.homepage.title") %></title>
...
%>
<link rel="canonical" href="<%=WebProperty.readUrl("site.url") %>${position[0].url}"/>
<c:if test="${empty category}">
<meta name="keywords" content="<%=WebProperty.readUrl("site.front.homepage.keywords") %>"/>
<meta name="description" content="<%=WebProperty.readUrl("site.front.homepage.description") %>"/>
</c:if><c:if 
test="${!empty category}"><meta name="keywords" content="${category.meta_KeyWords}"/>
<meta name="description" content="${category.meta_Description}"/></c:if>
</head>
