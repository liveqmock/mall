...
<jsp:include page="/WEB-INF/page/share/head.jsp"/>
     ...
     <div id="position">您现在的位置: &nbsp;<a href="" name="linkHome" title="回到首页" alt="AngelInTheBox首页">Angel In The Box</a>&nbsp;<a href="blog"></a> 
</div>
...
<c:forEach items="${pm.datas}" var="article">
    <tr>
	  ...
	  <td bgcolor="#f5f5f5"> <div align="center"><a href="<%=ConstantString.BLOG %><%=ConstantString.SEPERATORSLASH %>${article.url }<%=ConstantString.BLOGFILESUFFIX %>">${article.title }</a></div></td>
...
%>  </div>
  <pg:pager items="${pm.total }" url="blog" export="currentPageNumber=pageNumber">
