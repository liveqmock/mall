...
<c:forEach items="${pageView.records}" var="entry">
    <tr>
      ...
      <td bgcolor="f5f5f5"> <div align="center"><a href="<html:rewrite action="control/department/manage"/>?method=editUI&departmentid=${entry.id}">
    ...
    <tr> 
      <td bgcolor="f5f5f5" colspan="4" align="center"><table width="100%" border="0" cellspacing="1" cellpadding="3">
          <tr> 
            <td width="5%"></td>
              <td width="85%">
              <input type="button" class="frm_btn" onClick="javascript:window.location.href='<html:rewrite action="control/department/manage"/>?method=addUI'" value="添加部门"> &nbsp;&nbsp;
            </td>
          </tr>
        </table></td>
    </tr>
