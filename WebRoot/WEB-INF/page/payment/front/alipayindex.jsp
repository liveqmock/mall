...
<table width="960" border="0" align="center">
  <tr>
	...
	<form action="pay/yeepay.do" method="post" name="paymentform">
	<input type="hidden" name="method" value="gotoyeepay"/>
	<table width="100%" border="0">
      <tr>
        <td height="30" colspan="4"><table width="100%" height="50" border="0" cellpadding="0" cellspacing="1" bgcolor="#A2E0FF">
          <tr>
            <td align="center" bgcolor="#F7FEFF"><h3>订单号：${order.orderId }
           <input type="hidden" name="orderId" value="${order.orderId }"/>
	 应付金额：￥ ${ order.totalOrderPrice}元</h3></td>
          </tr>
        </table></td>
        </tr>
      <tr>
