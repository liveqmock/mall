...
<input type="hidden" name="method" value="updateProductDetailGroup"/>
...
<br>
  <table width="90%" border="0" cellspacing="2" cellpadding="3" align="center">
    ...
    <tr bgcolor="f5f5f5"> 
      ...
      <td width="78%"> <input type="text" name="name" size="50" maxlength="50" value="${group.name}"/>
    </tr>
     <tr bgcolor="f5f5f5"> 
      <td width="22%" > <div align="right">产品详情组内容</div></td>
      <td width="78%"> <input type="text" name="detail" size="50" maxlength="50" value="${group.post}"/>
    </tr>
    <tr bgcolor="f5f5f5"> 
