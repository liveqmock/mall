...
<c:forEach items="${entry.styles}" var="pic">${pic.image140FullPath}</c:forEach>
		<div class="goodslist">
          <div class="goods" style="cursor:hand;background:url('') center center no-repeat"><a href="<html:rewrite action="product/view"/>?productid=${entry.id}" target="_blank">
