...
<tr><td>邮箱：</td><td><input class="text" type="text" maxlength="20" size="20" id="email" name="email" onfocus="this.className='text highlight'" onblur="this.className='text'"></td></tr>
<tr><td>密码：</td><td><input class="text" type="password" maxlength="20" size="20" id="password" name="password" onfocus="this.className='text highlight'" onblur="this.className='text'"></td></tr>
<tr><td colspan="2"><input type="image" border="0" alt="登录" src="images/global/regloginbutton2.jpg" class="loginimage"><div style="float:right"><a href="user/manage.do?method=forgetPassword">忘记密码？</a></div></td></tr>
</tbody>
</table>
</form>
</td>
...
<tbody>
<tr>
<td colspan="2">新用户注册</td></tr>
<tr><td>邮箱：</td><td>
<input class="text" type="text" maxlength="20" size="20" id="regemail" name="email" onfocus="this.className='text highlight'" onblur="this.className='text';checkAvailiable(this.value)"/>
...
<tr><td>密码：</td><td><input class="text" type="password" maxlength="20" size="20" id="password" name="password" onfocus="this.className='text highlight'" onblur="this.className='text'"/></td></tr>
<tr><td colspan="2"><input type="image" border="0" alt="注册" src="images/global/reg.jpg" class="loginimage" /></td></tr>
</tbody>
</table>
</form>
</td>
