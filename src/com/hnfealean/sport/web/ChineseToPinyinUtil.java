...
public class ChineseToPinyinUtil {
	...
	public static String getFullSpell(String cnStr) {
		...
		if(WebProperty.readUrl("site.url.caselower").equals("1"))
			return retuBuf.toString().toLowerCase();
		else return retuBuf.toString();
	}
	...
	public static void main(String[] args) {
		String str = null;
		str = "黄德添";
		System.out.println("Spell=" + ChineseToPinyinUtil.getFullSpell(str));
	}
}
